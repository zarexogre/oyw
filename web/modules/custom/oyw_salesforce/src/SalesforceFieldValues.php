 ...
 * "options_allowed_values" hook, which populates the values for the "field_gender"
 * field.  The class should call the "getPicklistValues" client method like so:
...
class SalesforceFieldValues
{
     ...
     * Using new php feature here property promotion keeps consturctor nice and clean.
     */
